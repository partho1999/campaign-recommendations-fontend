...
export default function Page() {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try {
      const res = await fetch(`https://adrecommend.waywisetech.com/api/predict-date-range/?start_date=${startDate}&end_date=${endDate}`);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("https://adrecommend.waywisetech.com/api/prediction-daily");
